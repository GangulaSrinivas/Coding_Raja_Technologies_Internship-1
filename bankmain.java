...
public class BankMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("SRINIVAS ONLINE BANK");

        jButton1.setText("Create Account");
        jButton1.addActionListener(this::jButton1ActionPerformed);

        jLabel1.setFont(new Font("Microsoft Sans Serif", 1, 15)); // NOI18N
        jLabel1.setText("WELCOME TO SRINIVAS ONLINE BANK!");
    ...
    private void jButton6ActionPerformed(ActionEvent evt) {
        JOptionPane.showMessageDialog(null,"Created By gangulasrinivas112@gmail.com\n", "About", 1);
    }
